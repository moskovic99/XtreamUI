...
* sudo apt-get update && sudo apt-get upgrade -y && sudo apt-get install libxslt1-dev libcurl3 libgeoip-dev python -y; wget https://github.com/moskovic99/XtreamUI/blob/main/install.py; sudo python install.py  
